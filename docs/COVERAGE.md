...
| Image / chart / TTS briefs | Frame & Tone Kit | mapped |
...
| Versioning | Draft Lineage | mapped |
| Archive | Version Vault | mapped |
...
| Calendar | PULSE calendar | mapped |
| Post / thread / carousel / caption / hook | matching modes + SNAP | mapped |
| Repurpose | atomize | mapped |
| Performance | Pulse Readout Deep | mapped |
| Patterns | Format Signal Mine | mapped |
